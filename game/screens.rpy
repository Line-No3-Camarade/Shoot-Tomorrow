...
##             textbutton "Test: 개발 테스트":
##                 action Start()

##             textbutton "Ep.1: 귀환":
##                 action Start("script_ep1")
                
##             textbutton "Ep.2: 사라지는 아침":
##                 action Start("script_ep2")
        
##             textbutton "Ep.3: 뒤집히는 세상":
##                 action Start("script_ep3")
        
##             textbutton "Ep.4: ":
##                 action Start("script_ep4")
            
##             textbutton "Ep.5: ":
##                 action Start("script_ep5")
...
### 배포 시 사용할 단락
            ...
            # textbutton "Ep.1: 귀환":
                # if persistent.ep1:
                    # action Start("ep1_script")
                # else:
                    # action ShowMenu("epi_locked")
                
            # textbutton "Ep.2: 사라지는 아침":
                # if persistent.ep2:
                    # action Start("ep2_script")
                # else:
                    # action ShowMenu("epi_locked")
        
            # textbutton "Ep.3: 부평초":
                # if persistent.ep3:
                    # action Start("ep3_script")
                # else:
                    # action ShowMenu("epi_locked")
        
            # textbutton "Ep.4: 암흑":
                # if persistent.ep4:
                    # action Start("ep4_script")
                # else:
                    # action ShowMenu("epi_locked")
            
            # textbutton "Ep.5: 이방인":
                # if persistent.ep5:
                    # action Start("ep5_script")
                # else:
                    # action ShowMenu("epi_locked")
            
            # textbutton "Ep.6: 던져진 운명":
                # if persistent.ep6:
                    # action Start("ep6_script")
                # else:
                    # action ShowMenu("epi_locked")
...
screen epi_locked():
    ...
    textbutton "아직 스토리를 진행하지 않았습니다.":
        xalign 0.5
        yalign 0.5
        action Hide("epi_locked"), ShowMenu("episodes")

style epi_button is gui_button
style epi_button_text is gui_button_text

style epi_button:
    properties gui.button_properties("epi_button")
    ymargin 50

style epi_button_text:
    properties gui.button_text_properties("epi_button")
